...
function MoviesDetails({ movieId, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-neutral-900/95 backdrop-blur-sm overflow-y-auto scroll">
      <div className="relative w-full max-w-5xl bg-neutral-800 rounded-lg shadow-xl max-h-[90vh] overflow-y-auto">
        {/* Close Button */}
        <button
          className="absolute top-4 right-4 z-10 p-2 rounded-full bg-neutral-700/80 text-white hover:bg-neutral-600/80 transition-all cursor-pointer"
          onClick={onClose}
        >
          <svg
        ...
        {loading ? (
          ...
          <div className="flex items-center justify-center h-96">
            <div className=" text-center">
              ...
              <button className="mt-6 bg-purple-600 hover:bg-purple-700 text-white px-6 p-rounded-md cursor-pointer">
                Close
              </button>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="p6 md:p-8">
              <div className="md:flex flex-wrap gap-8 -mt-32 md:-mt-48 relative">
                {/* Poster */}
                ...
                <div className="flex-1">
                    ...
                    {movie.vote_average > 0 && (
                      <div className="flex items-center">
                        <svg
                          ...
                          fill="currentColor"
                        >
                          <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.758.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.539 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.839-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.758-.69l1.07-3.292z" />
                        </svg>
                  ...
                  <div className="mt-8 flex flex-wrap gap-3">
                    ...
                    <div className="bg-neutral-700 hover:bg-neutral-600 text-white px-6 py-3 rounded-lg flex items-center gap-2 transition-all cursor-pointer">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-5 w-5"
                        fill="none"
